...
const invoiceNumber = (order) => `FAC-${order.reference}`;
...
function createInvoicePdf(order) {
  return new Promise((resolve, reject) => {
    ...
    document.text(`Émise le ${formatDate(order.paidAt)}`, { align: "right" });
    document.moveDown(2);
    ...
    document.text("P.U. TTC", 385, tableTop + 8, { width: 70, align: "right" });
    document.text("TOTAL TTC", 465, tableTop + 8, {
      width: 70,
      align: "right",
    });
    ...
    document.text("Livraison", 60, y, { width: 250 });
    ...
    document.text("Total net à payer", 330, y, { width: 125 });
...
module.exports = { createInvoicePdf, invoiceNumber };
