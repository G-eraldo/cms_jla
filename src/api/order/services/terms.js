...
const TERMS_VERSION = "11 septembre 2026";
...
const TERMS_SECTIONS = [
  ...
  },
  {
    title: "5. Paiement",
    paragraphs: [
      "Le prix est payable comptant et en totalité. Les moyens de paiement proposés dès le début de la commande sont la carte bancaire, via la page sécurisée de Mollie. D'autres moyens peuvent être affichés par Mollie selon la banque du client. Maison JLA ne collecte ni ne conserve les données de carte bancaire. La commande n'est confirmée qu'après encaissement effectif.",
    ],
  },
  {
    title: "6. Livraison",
